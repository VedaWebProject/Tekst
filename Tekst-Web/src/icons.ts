...
export {
  ...
  FormatAlignRightOutlined as FormatAlignRightIcon,
  FormatBoldOutlined as FormatBoldIcon,
  FormatClearOutlined as FormatClearIcon,
  ...
  ExpandOutlined as ReducedViewOffIcon,
  CompressOutlined as ReducedViewOnIcon,
