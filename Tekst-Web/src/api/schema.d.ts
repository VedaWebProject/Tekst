...
export interface components {
    schemas: {
        ...
        /** @enum {string} */
        DeepLSourceLanguage: "ar" | "bg" | "cs" | "da" | "de" | "el" | "en" | "es" | "et" | "fi" | "fr" | "hu" | "id" | "it" | "ja" | "ko" | "lt" | "lv" | "nb" | "nl" | "pl" | "pt" | "ro" | "ru" | "sk" | "sl" | "sv" | "tr" | "uk" | "zh";
        ...
        LineLabellingConfig: {
             ...
             * @enum {string}
             */
            labellingType: "numbersZeroBased" | "numbersOneBased" | "lettersLowercase" | "lettersUppercase";
        };
        /** @enum {string} */
        LocaleKey: "deDE" | "enUS";
        /** LocationCoverage */
        ...
        LocationData: {
             ...
             * @default []
             */
            contents: (components["schemas"]["AudioContentRead"] | components["schemas"]["ExternalReferencesContentRead"] | components["schemas"]["ImagesContentRead"] | components["schemas"]["PlainTextContentRead"] | components["schemas"]["RichTextContentRead"] | components["schemas"]["TextAnnotationContentRead"])[];
        };
        /** LocationRead */
        LocationRead: {
            /**
        ...
        ResourceSearchQuery: {
             ...
             */
            rts: components["schemas"]["AudioSearchQuery"] | components["schemas"]["ExternalReferencesSearchQuery"] | components["schemas"]["ImagesSearchQuery"] | components["schemas"]["PlainTextSearchQuery"] | components["schemas"]["RichTextSearchQuery"] | components["schemas"]["TextAnnotationSearchQuery"];
        };
         ...
         * @enum {string}
         */
        TaskType: "indices_create_update" | "resource_import" | "resource_export" | "search_export" | "broadcast_user_ntfc" | "broadcast_admin_ntfc" | "resource_maintenance_hook" | "structure_update";
        /** TekstErrorModel */
        TekstErrorModel: {
        ...
        /** @enum {string} */
        UserNotificationTrigger: "messageReceived" | "newCorrection" | "resourceProposed" | "resourcePublished";
        /**
         * UserRead
...
export interface operations {
    ...
    getContentSiblings: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": (components["schemas"]["AudioContentRead"] | components["schemas"]["ExternalReferencesContentRead"] | components["schemas"]["ImagesContentRead"] | components["schemas"]["PlainTextContentRead"] | components["schemas"]["RichTextContentRead"] | components["schemas"]["TextAnnotationContentRead"])[];
                };
            };
            /** @description Not Found */
            404: {
    ...
    createContent: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AudioContentCreate"] | components["schemas"]["ExternalReferencesContentCreate"] | components["schemas"]["ImagesContentCreate"] | components["schemas"]["PlainTextContentCreate"] | components["schemas"]["RichTextContentCreate"] | components["schemas"]["TextAnnotationContentCreate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    updateContent: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AudioContentUpdate"] | components["schemas"]["ExternalReferencesContentUpdate"] | components["schemas"]["ImagesContentUpdate"] | components["schemas"]["PlainTextContentUpdate"] | components["schemas"]["RichTextContentUpdate"] | components["schemas"]["TextAnnotationContentUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    findResources: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": (components["schemas"]["AudioResourceRead"] | components["schemas"]["ExternalReferencesResourceRead"] | components["schemas"]["ImagesResourceRead"] | components["schemas"]["PlainTextResourceRead"] | components["schemas"]["RichTextResourceRead"] | components["schemas"]["TextAnnotationResourceRead"])[];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    createResource: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AudioResourceCreate"] | components["schemas"]["ExternalReferencesResourceCreate"] | components["schemas"]["ImagesResourceCreate"] | components["schemas"]["PlainTextResourceCreate"] | components["schemas"]["RichTextResourceCreate"] | components["schemas"]["TextAnnotationResourceCreate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    updateResource: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AudioResourceUpdate"] | components["schemas"]["ExternalReferencesResourceUpdate"] | components["schemas"]["ImagesResourceUpdate"] | components["schemas"]["PlainTextResourceUpdate"] | components["schemas"]["RichTextResourceUpdate"] | components["schemas"]["TextAnnotationResourceUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    performSearch: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["QuickSearchRequestBody"] | components["schemas"]["AdvancedSearchRequestBody"];
            };
        };
        responses: {
            /** @description Successful Response */
