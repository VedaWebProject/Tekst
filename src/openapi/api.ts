...
/**
 * TextRig platform information config model  These values are not configurable. They are taken from the package infos and aren\'t meant to be changed by users creating an own instance of the platform.
 * @export
 * @interface TextRigInfoConfig
 */
export interface TextRigInfoConfig {
    /**
     * 
     * @type {string}
     * @memberof TextRigInfoConfig
     */
    'name'?: string;
    /**
     * 
 ...
 * 
 * @export
 * @interface Textriginfo
 */
export interface Textriginfo {
    /**
     * 
     * @type {string}
     * @memberof Textriginfo
     */
    'name'?: string;
    /**
     * 
...
export const TextsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        importText: async (file: File, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'file' is not null or undefined
            assertParamExists('importText', 'file', file)
            const localVarPath = `/texts/import`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const TextsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async importText(file: File, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TextRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.importText(file, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const TextsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * 
         * @summary Import text
         * @param {TextsApiImportTextRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        importText(requestParameters: TextsApiImportTextRequest, options?: AxiosRequestConfig): AxiosPromise<TextRead> {
            return localVarFp.importText(requestParameters.file, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update text
...
/**
 * Request parameters for importText operation in TextsApi.
 * @export
 * @interface TextsApiImportTextRequest
 */
export interface TextsApiImportTextRequest {
    /**
     * 
     * @type {File}
     * @memberof TextsApiImportText
     */
    readonly file: File
}
...
export class TextsApi extends BaseAPI {
     ...
     * @memberof TextsApi
     */
    public importText(requestParameters: TextsApiImportTextRequest, options?: AxiosRequestConfig) {
        return TextsApiFp(this.configuration).importText(requestParameters.file, options).then((request) => request(this.axios, this.basePath));
    }
