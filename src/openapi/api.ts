...
export const UserCreateLocaleEnum = {
    DeDe: 'deDE',
    EnUs: 'enUS'
} as const;
...
export const UserUpdateLocaleEnum = {
    DeDe: 'deDE',
    EnUs: 'enUS'
} as const;
...
export const AdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUsers(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<UserRead>>> {
...
export const TextsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} id 
         * @param {number} index Index to insert the level at
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteLevel: async (id: string, index: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/texts/{id}/level/{index}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)))
